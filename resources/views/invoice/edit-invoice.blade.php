...
@section('title') {{ __('Update Service') }} @endsection
@section('css')
...
@section('body')
    ...
    @section('content')
        ...
        @component('components.breadcrumb')
            ...
            @slot('li_3') Update Service @endslot
        @endcomponent
        <!-- end page title -->
        <div class="row">
            <div class="col-12">
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <blockquote>{{ __('Service Details') }}</blockquote>

                        <form class="outer-repeater" action="{{ url('invoice/' . '' . $service->id) }}" method="post">
                            @method("PATCH")
                            @csrf
                            <div class="row">
